...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.bg_canvas.pack(side="bottom", fill="both", expand=True)
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        ...
        text = (
            ...
            "Protecting the environment is essential for maintaining biodiversity.\n"
            "Sustainable development helps balance economic growth and environmental care.\n"
            "Conservation efforts can restore damaged ecosystems.\n"
            "Individual actions, like reducing waste, contribute to global health.\n"
            "Government policies play a crucial role in environmental protection.\n"
            "Education raises awareness about environmental challenges.\n"
            "Innovations in technology can provide eco-friendly solutions."
        )
        ...
        self.fg_canvas.pack(fill="both", expand=True, pady=10)
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        text = (
            ...
            "- Reducing carbon footprint by using public transport\n"
...
class App(tk.Tk):
    def __init__(self):
        ...
        # Exit button frame at top right corner
        exit_frame = tk.Frame(self)
        exit_frame.pack(side="top", anchor="ne", fill="x")
        exit_button = tk.Button(exit_frame, text="Exit", font=("Helvetica", 12, "bold"), fg="white", bg="red", command=self.destroy)
        exit_button.pack(side="right", padx=10, pady=5)

        container = tk.Frame(self)
        container.pack(fill="both", expand=True)

        # Set grid weight to allow frames to expand fully
